  ...
  <div className="relative py-6 sm:max-w-lg sm:mx-auto">
    ...
    >
      <div className="max-w-lg mx-auto">
        <div>
          <h1 className="text-3xl font-semibold text-center">Welcome Back, Please Login</h1>
        </div>
        <div className="divide-y divide-gray-300 mt-6">
          ...
          >
            ...
            {error ? <p className='text-red-600 font-bold text-base'> email or password is incorrect</p> : ""}
